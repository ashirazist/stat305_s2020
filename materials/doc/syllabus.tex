...
\end{center}
\centerline{\textbf{TR 02:10 - 03:30 PM, Agronomy Hall 2020}}
...
\begin{center} \begin{minipage}{6.5in}
		\begin{flushleft}
			...
			TA \dotfill  Huo, Yonghui (huoyh@iastate.edu, office hours: Wed 02:00- 03:00, Fri  09:00- 10:00,  Snedecore Hall) \\
...
\begin{center} \begin{minipage}{6.5in}
		\begin{flushleft}
			...
			, Thursday \\
			Course Final \dotfill May 5, Tuesday 02:15- 04:15., location:  Agronomy Hall 2020\\
		\end{flushleft}
	\end{minipage}
\end{center}
\vskip.25in
			...
			\begin{center} 
				\begin{minipage}{6in}
					\begin{flushleft}
						...
						Final Exam \dotfill 40\% (May 5, Tuesday 02:15- 04:15., location:  Agronomy Hall 2020) \\
					\end{flushleft}
				\end{minipage}
			\end{center}
		\end{flushleft}
