...
\begin{center}
<<fig.width=5, fig.height=5, out.width='.5\\linewidth', echo=FALSE, message=FALSE, warning= FALSE, fig=TRUE>>=
  library(ggplot2)
...
Here are some summaries of the data:
      ...
      \begin{align*}
         b_1 &= \frac{ \sum_{i = 1}^n x_i y_i - n \bar{x} \bar{y} }{ \sum_{i = 1}^n x_i^2 - n \bar{x}^2 } \\
             ...
             &= \Sexpr{ ( (1982) - (50) * (64/50) * (1996/50) )/( 107 - 50 * (64/50)^2 ) } \\
      \end{align*} 
      and with $b_1$ we can find the value fo $b_0$: 
      \begin{align*}
         b_0 &= \bar{y} - b_1 \bar{x} \\
             &= (1996/50) - (\Sexpr{ ( (1982) - (50) * (64/50) * (1996/50) )/( 107 - 50 * (64/50)^2 ) }) (64/50) \\
             &= \Sexpr{(1996/50) - ( ( (1982) -  (50) * (64/50) * (1996/50) )/( 107 - 50 * (64/50)^2 ) )* (64/50) } \\
      \end{align*} 
      ...
      \item Find and interpret the value of $R^2$ for the fitted linear relationship.[5 pts]\\
            ...
            r &= \frac{\sum_{i=1}^n x_i y_i - n \bar{x} \bar{y}}{\sqrt{\left(\sum_{i=1}^n x_i^2 - n \bar{x}^2\right)\left(\sum_{i=1}^n y_i^2 - n\bar{y}^2\right)}} \\
              ...
              &= \Sexpr{ ( (1982) - (50) * (64/50) * (1996/50) )/(sqrt( (107 - 50 * (64/50)^2 ) *(94078 - (50) * (1996/50)^2 ))) } \\
            \end{align*} 
            So $R^2 = (r)^2 = \Sexpr{( ( (1982) - (50) * (64/50) * (1996/50) )/(sqrt( (107 - 50 * (64/50)^2 ) *(94078 - (50) * (1996/50)^2 ))) )^2}$\\
      ...
      \item Using the fitted line, provide a predicted value of travel distance to failure when the weight exceeding the guidelines is 3.4 tonnes.[5 pts]\\
         $$ \hat{y} = 69.15 -22.84(3.4) = \Sexpr{69.15 -22.84*(3.4)} $$
