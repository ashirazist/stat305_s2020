...
\lhead{STAT 305}
\chead{Homework 8} 
\rhead{Due Thursday, April $16^{th}$ on Canvas}
\lfoot{Spring 2020} 
\cfoot{\thepage} 
...
\textbf{Please write as legibly as possible because if the TA cannot read your handwriting, it may cause confusion and ends up in deduction.}
