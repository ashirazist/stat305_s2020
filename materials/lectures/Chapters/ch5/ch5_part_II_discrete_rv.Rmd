...
![](https://media.giphy.com/media/b3rveIiz8xcdi/giphy.gif)
...
.right-column[
Using **random variables** we can translate **events** into the world of mathematics and probability. So, we can then express  event occuring in the language of **probability**
...
> <font color="red">Discrete:</font> <font color="blue">P</font>robability <font color="blue">M</font>ass <font color="blue">F</font>unction (<font color="blue">pmf</font>)
>
> <font color="red">Continuous:</font> <font color="blue">P</font>robability <font color="blue">D</font>ensity <font color="blue">F</font>unction (<font color="blue">pdf</font>)

A probability mass function (pmf) gives probabilities of occurance for <font color="red">individual</font> values. 
...
>i.e. a dicrete random variable X takes individual (discrete) values in an interval.

e.g. 
$$P (X\color{red}\leq 3) = P(X=1) + P(X=2) + P(X=3) $$
or 
$$P (2\color{lightblue}< X\leq 4)= P(3\color{red}\leq X\color{red}\leq 4) = P(X=3) + P(X=4) $$

but 
$$P(X\in (2, 3)) = P(2\color{lightblue}<X\color{pink}<3) = 0$$
or 

$$P(3 \color{lightblue}<X \color{red}\leq 4)= P(X=4)$$
]
---
.left-column[
### General Info
...
.right-column[
#### Properties of a <font color="red">valid</font> probability function. 

In order to have a valid pmf we need 

>1) $f(x)\geq 0$ for $\forall x\in S$

>2) $\sum_{x} f(x)=1$ (probabilties sum to one)

#### Example
Let $f(x)$ be a pmf defined as 
...
What value of **a** makes $f(x)$ a valid pmf?
]
---
.left-column[
### General Info
...
\end{cases}
$$
1) $f(x)\geq 0 \forall x \in (-2, -1, 0, 1, 2) \Rightarrow a\geq 0$

2) $\sum_{x\in (-2, -1, 0, 1, 2)} f(x)=1$. so, 

\begin{align*}
1 &= f(-1)+ f(1)+ f(0)+ f(2)+ f(-2)\\\\
  &= 1/8 +1/8 +a + 1/4 + 1/4\\\\
  &= a + 2/8+ 1/2
\end{align*}

which gives us $a=1/4$
]
---
.left-column[
### General Info
...
Suppose that the we roll a die and let $T$ be the number of dots facing up. 

Define the probability distribution of $T$. Find $f(3)$, $P(3< X\leq 6)$, $F(3)$ and $F(6)$.
...
![](https://media.giphy.com/media/1Cho4T0V1ddAc/giphy.gif)
...
We can write write the pmf and CDF of T in a table like

|   T       | 1    |  2    |  3    |  4    |  5    |  6    | 
|----------|-------|-------|-------|-------|-------|-------|
| **f(T)** |  1/6  |  1/6  | 1/6   | 1/6   | 1/6   | 1/6   |
| **F(T)** |1/6    |2/6    | 3/6   |  4/6  |  5/6  |  1    | 

- $f(3)= 1/6$

- $P(3< T\leq 6)= P(4\leq T\leq 6)  \\ =f(4) + f(5)+ f(6)\\= 1/6 + 1/6+ 1/6 = 3/6$

- $F(3)= P(T\leq 3)= f(1)+ f(2)+ f(3)\\= 1/6 + 1/6 + 1/6= 3/6$

- $F(6)= P(T\leq 6)=  \sum_{t=1}^{6} f(T) = 1$
]
---
.left-column[
### General Info
...
\begin{align*}
P(Z \le 14)&= P(Z= 11\  \text{or}\  Z=12\  \text{or}\  Z= 13\  \text{or}\  Z=14)\\\\ 
&=P(Z=11)+ P(Z=12)+ P(Z=13)+ P(Z=14)\\\\
&=0.03+ 0.03+ 0.03 +0.06\\\\
&= 0.15 
\end{align*}
...
\begin{align*}
P(Z > 12)&= P(Z= 13\  \text{or}\  Z=14 \  \text{or}\  Z=15\ \text{or}\  Z= 16\\
&\text{or}\  Z=17\  \text{or}\  Z= 18\  \text{or}\  Z=19 \  \text{or}\  Z=20)\\\\ 
&=P(Z=13)+ P(Z=14) +P(Z=15) +P(Z=16)\\
&+ P(Z=17)+ P(Z=18)+ P(Z=19)+ P(Z=20)\\\\
&=0.03+ 0.03 +0.06 + 0.26+ 0.09+ 0.12+ 0.2+ 0.15+ 0.03\\\\
&= 0.97 
\end{align*}
</span>
]
...
That is a very long way. A smarter way is to use **complement** probability.
...
\begin{align*}
P(Z \text{ is even})&= P(Z=12 \ \text{or} \ Z= 14\  \text{or}\  Z=16 \  \text{or}\  Z=18\  \text{or}\  Z=20 )\\
&= P(Z=12) + P(Z=14)+ P(Z=16)\\
&+  P(Z=18)+ P(Z=20)\\\\
&= 0.03 + 0.06 + 0.09 + 0.2 + 0.03\\
&= 0.41
\end{align*}
]
---
...
\begin{align*}
P(Z \in \{15, 16, 18\})&=  P(Z=15 \ \text{or} \ Z= 16\  \text{or}\  Z=18 )\\
&= P(Z= 15) + P(Z=16) + P(Z=18)\\
&= 0.26 + 0.09 + 0.2\\&= 0.55
\end{align*}
...
class: center, middle, inverse
---
##More on Cumulative Probability Function (CDF)
---
layout:false
.left-column[
### General Info
