...
#### Assessing models
#### Residual plot
```{r residual_plots, results='hold', out.width=".48\\textwidth", fig.height = 2.5, fig.width = 4, fig.align='center'}
b0 <- 4.67
b1 <- .92
...
```{r, results='hold', out.width=".48\\textwidth", fig.height = 2.5, fig.width = 4, fig.align='center'}
