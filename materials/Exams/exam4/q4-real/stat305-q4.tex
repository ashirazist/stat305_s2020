...
\part[4] Provide a  90\% lower bound confidence interval for the true average distance before takeoff.
...
\begin{parts}
\part[4] Provide a two-sided 90\% confidence interval for the mean volume of gasoline recognized by the pump to be 1.00 gallons. 
\part[4] Provide a one-sided upper bound 95\% confidence interval for the mean volume of gasoline recognized by the pump to be 1.00 gallons.
...
\begin{parts}
   ...
   \part[6] Conduct a hypothesis test at the $\alpha = 0.05$ significance level for the claim that the true difference between the true means of the two O-rings ($\mu_X- \mu_Y$)  are significantly different.\\
\emph{Note: Write down all six steps for full credit.}
\end{parts}
