...
\usepackage{Sweave}
\begin{document}
\input{stat305-exam1_s20_sol-concordance}
...
\includegraphics{stat305-exam1_s20_sol-003}
   \vspace{6cm}
...
\underline{Note that here \verb!1 | 4 represents 1.4}. In this case, the first quartile is $Q(.25) = 4.7$, 
...
%-- : R plot (results in document)
\includegraphics{stat305-exam1_s20_sol-012}
...
\begin{table}[h!]
   ...
   \begin{tabular}{ccccccc}
          i   & 1 & 2 & 3 & 4 & 5 & 6  \\ \hline
      $p= \frac{i-.5}{6}$    & 0.08 & 0.25 & 0.42 & 0.58 & 0.75 & 0.92 \\ \hline
      $Q_{N}(p)$ & -1.41 & -0.67 & -0.2 & 0.2 & 0.67 & 1.41 \\ \hline
      $Q(p)$ &     &     &     &     &     &     \\
   \end{tabular}
\end{table}
\vspace{1cm}
%-- : R plot (results in document)
\includegraphics{stat305-exam1_s20_sol-014}
