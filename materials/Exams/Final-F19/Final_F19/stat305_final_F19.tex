...
\begin{document}
	...
	\begin{coverpages}
		...
		\fbox{\fbox{\parbox{5.5in}{
					...
					\vspace{.25cm} 
					\begin{itemize}
						\item The exam is scheduled for 150 minutes, from 12:00 PM to 04:00 PM. At  04:00 PM  the exam will end.\\
						
						\item You can start anytime between 12:00 - 04:00 PM, but your MUST SUBMIT YOUR ANSWER WITHIN 150 MINUTES.\\
						
						\item  Total points for the exam is 80. Points for individual questions are given at the beginning of each problem. Show all your calculations clearly to get full credit. Put final answers in the box at the right (except for the diagrams!).
...
\vspace{3cm}
\newpage
\part[3] Using this fitted multivariate linear relationship, what do we suppose the salary would be for an engineer with a undergraduate GPA of 3.73 living in a location with a median income of 31.88 thousand dollars?

\hfill \fbox{ \textcolor[rgb]{1.00,1.00,1.00}{$\bigcap$} \hskip -0.4cm $\hat y =$ \hspace{10cm}}
\vspace{3cm}
\part[3] The actual salary of one engineer surveyed with a undergraduate GPA of 3.73 living in a location with a median income of \$31,880 was \$83,040.  What is the residual for this specific engineer's actual salary using the fitted multivariate linear relationship? 
...
\begin{itemize}
\item System 1: 0.79, 0.83, 0.78, 0.84, 0.86, 0.81, 0.8, 0.78, 0.88, 0.88 (with $\bar{x_1} = 0.82, s_1^2 = 0.0015$)
\item System 2: 0.82, 0.75, 0.73, 0.78, 0.81, 0.77, 0.74, 0.82, 0.76, 0.76 (with $\bar{x_2} = 0.77, s_2^2 = 0.0011$)
\end{itemize}
